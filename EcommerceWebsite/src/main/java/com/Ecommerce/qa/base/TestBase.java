...
public class TestBase {
	...
	public TestBase() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("/Users/macmini/Documents/Selenium new/selenium script/EcommerceWebsite/src/main/java/com/Ecommerce/qa/config/config.properties");
			prop.load(ip);
	...
	public static void initialization() {
		...
		if(browserName.equals("chrome")) {
			...
			System.setProperty("webdriver.chrome.driver", "/Users/macmini/Documents/Selenium new/selenium script/EcommerceWebsite/drivers/chromedriver");
